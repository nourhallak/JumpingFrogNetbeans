...
//            System.out.println("Frog Not Found");
            ...
            if (mouseX >= 800 && mouseX <= 1000 && mouseY >= 20 && mouseY <= 60 && !frogs.isDone()) {
                //call reset function
